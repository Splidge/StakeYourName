...
contract InvestmentManager is Ownable {
    ...
    address internal kovanLendingPoolAddressProviderAddress =
        0x88757f2f99175387aB4C6a4b3067c77A695b0349;
    address internal mainLendingPoolAddressProviderAddress =
    ...
    function getAToken(address _asset) public view returns (address) {
        ...
        (_aTokenAddress, , ) = protocolDataProvider.getReserveTokensAddresses(
            _asset
        );
        return _aTokenAddress;
    }

    function getATokenBalance(address _asset, address _userVault)
        internal
        view
        returns (uint256)
    {
    ...
    function getBalance(address _asset, address _vault)
        public
        view
        returns (uint256)
    {
    ...
    function getInterest(address _asset, address _vault)
        external
        view
        returns (uint256)
    {
    ...
    function getTotal(address _asset, address _vault)
        external
        view
        returns (uint256)
    {
